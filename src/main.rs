...
// bitflags! {
//     #[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
//     struct GrammaticalAspect: u64 {
//         const PERFECTIVE = 1;
//         const MOMENTANE = 2;
//         const PERFECT = 4;
//         const RECENT_PERECT = 8;
//         const DISCONTINOUS_PAST = 16;
//         const PROSPECTIVE = 32;
//         const IMPERFECTIVE = 64;
//         const HABITUAL = 128;
//         const CONTINUOUS = 256;
//         const PROGRESSIVE = 512;
//         const STATIVE = 1024;
//         const GNOMIC = 2048;
//         const EPISODIC = 4096;
//         const CONTINUATIVE = 8192;
